  ...
  return (
    <div className="font-sarabun bg-[#001334] pb-10 w-full flex flex-col items-center justify-center">
      ...
      <div className="relative bg-[#0B2D58] px-4 sm:px-8 md:px-10 py-6 flex flex-col lg:flex-row items-center w-[95%] lg:w-[85%] max-w-[1600px] justify-center gap-2 md:gap-4 lg:gap-6">
        <div
          className="lg:-rotate-10 w-[300px] sm:w-[350px] h-[333px] sm:h-[350px] lg:w-[350px] xl:w-[380px] 2xl:w-[420px] p-6 sm:p-8 rounded-xl lg:rounded-2xl xl:rounded-3xl text-white flex flex-col gap-2 relative z-10 lg:-mr-12 overflow-hidden"
          style={{
        ...
        <div
          ...
          pt-6 pr-6 pb-12 pl-4 sm:pt-8 sm:pr-8 sm:pb-24 sm:pl-10 rounded-xl lg:rounded-2xl xl:rounded-3xl text-white flex flex-col gap-2 relative z-10 lg:-ml-12 overflow-hidden h-auto"
          style={{
