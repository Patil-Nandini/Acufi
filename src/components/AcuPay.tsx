...
export default function AcuPay() {
 return (
   <div className="font-sarabun bg-[#001334] pb-10 w-full flex flex-col items-center justify-center ">
     ...
     <div className="relative bg-[#0B2D58] px-4 sm:px-8 md:px-10 py-6 flex flex-col lg:flex-row items-center w-[95%] lg:w-[85%] justify-center lg:justify-between gap-2 md:gap-0">
       <div
         className="lg:-rotate-10 w-[300px] sm:w-[350px] h-[333px] sm:h-[350px] lg:w-[350px] xl:w-[350px] p-6 sm:p-8 rounded-xl lg:rounded-[24px] text-white flex flex-col gap-2 relative z-10 lg:-mr-6 xl:-mr-6 overflow-hidden"
         style={{
       ...
       <div className="lg:-mt-40">
         ...
         <object
           type="image/svg+xml"
           data="/pin.svg"
           className="hidden lg:block w-[300px] h-[250px] xl:w-[350px] xl:h-[300px]"
           aria-label="Payment Connectivity Desktop"
         />
       </div>

       <div
         className="lg:rotate-10 w-[300px] sm:w-[350px] h-[333px] sm:h-[350px] lg:w-[350px] xl:w-[350px]
         pt-6 pr-6 pb-12 pl-4 sm:pt-8 sm:pr-8 sm:pb-24 sm:pl-10 rounded-xl lg:rounded-[24px] text-white flex flex-col gap-2 relative z-10 lg:-ml-6 xl:-ml-6 overflow-hidden"
         style={{
       ...
       >
         ...
         <ul className="flex flex-col gap-[20px] lg:gap-[25px] text-[14px] pl-2 xl:pl-0 lg:pl-0 font-sarabun">
           {[
             ...
             <li
               key={index}
               className="flex items-start gap-0 lg:pl-1"
             >
               <Image
                 src="/GreenCheckMarkIcon.svg"
                 alt="Check"
