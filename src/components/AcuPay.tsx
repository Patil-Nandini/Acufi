...
//       <div className="flex flex-col lg:flex-row items-center justify-between bg-[#0B2D58] text-white rounded-t-[14px] px-5 sm:px-8 lg:px-9 w-[95%] lg:w-[85%] max-w-[1600px] py-8 gap-8">
//         <div className="flex-[1.6] text-left">
//           <h2 className="text-2xl sm:text-3xl font-semibold mb-4">
//             Modern Payment Processing… Built for High-Risk Businesses
//           </h2>
...
//       <div className="relative bg-[#0B2D58] px-4 sm:px-8 md:px-10 py-6 flex flex-col lg:flex-row items-center w-[95%] lg:w-[85%] max-w-[1600px] justify-center gap-2 md:gap-4 lg:gap-6">
//         <div
//           className="lg:-rotate-10 w-[300px] sm:w-[350px] h-[333px] sm:h-[350px] lg:w-[350px] xl:w-[380px] 2xl:w-[420px] p-6 sm:p-8 rounded-xl lg:rounded-[24px] xl:rounded-3xl text-white flex flex-col gap-2 relative z-10 lg:-mr-12 overflow-hidden"
//           style={{
//             backgroundImage: "url('/ACH-Processing-bg.webp')",
//             backgroundSize: "cover",
//             backgroundPosition: "center",
//           }}
//         >
//           <h3 className="font-semibold text-base sm:text-lg lg:text-sm xl:text-lg xl:pl-10 pl-10 lg:pl-8 mb-4">
//             ACH Processing
//           </h3>
//           <ul className="flex flex-col gap-[20px] lg:gap-[25px] text-[14px] pl-10 xl:pl-8 lg:pl-6 font-sarabun">
//             {[
...
//                   className="w-6 h-6"
//                 />
//                 <span className="leading-4 lg:leading-3.5 xl:leading-5 tracking-[-0.01em] pl-0.5 break-words">
//                   {text}
//                 </span>
//               </li>
//             ))}
...
//         <div className="lg:-mt-32 xl:-mt-36 lg:px-0 xl:px-0">
//           <object
//             type="image/svg+xml"
//             data="/ACH-processing-Vertical-for-Mobile.svg"
//             className="w-[250px] h-[200px] sm:w-[350px] sm:h-[280px] lg:hidden"
//             aria-label="Payment Connectivity Mobile"
//           />
//           <object
//             type="image/svg+xml"
//             data="/pin.svg"
//             className="hidden lg:block w-[250px] h-[200px] xl:w-[280px] xl:h-[240px]"
//             aria-label="Payment Connectivity Desktop"
//           />
//         </div>

//         <div
//           className="lg:rotate-10 w-[300px] sm:w-[350px] lg:w-[350px] xl:w-[380px] 2xl:w-[420px]
//           pt-6 pr-6 pb-12 pl-4 sm:pt-8 sm:pr-8 sm:pb-24 sm:pl-10 rounded-xl lg:rounded-[24px] xl:rounded-3xl text-white flex flex-col gap-2 relative z-10 lg:-ml-12 overflow-hidden h-auto"
//           style={{
//             backgroundImage: "url('/Creit-Debit-Card-Processing.webp')",
//             backgroundSize: "cover",
//             backgroundPosition: "center",
//           }}
//         >
//           <h3 className="font-semibold text-base sm:text-lg lg:text-sm xl:text-lg xl:pl-2 pl-2 lg:pl-0 tracking-tighter mb-4">
//             Credit & Debit Card Processing
//           </h3>
//           <ul className="flex flex-col gap-[20px] lg:gap-[25px] text-[14px] pl-2 xl:pl-0 lg:pl-0 font-sarabun">
//             {[
//               "Accept All Major Card Brands",
//               "Built-In Fraud Protection And <br/> Chargeback Mitigation",
//               "Fast, Secure Digital Checkout<br/> Experiences",
//               "Supports High Volume And <br/>High-Ticket Transactions",
//             ].map((feature, index) => (
//               <li key={index} className="flex items-start gap-0 lg:pl-1">
//                 <Image
//                   src="/GreenCheckMarkIcon.svg"
//                   alt="Check"
//                   width={24}
...
//                   className="w-6 h-6 flex-shrink-0"
//                 />
//                 <span className="leading-5 tracking-[-0.01em] pl-0.5 break-words text-[clamp(0.85rem,1vw,1rem)]">
//                   {feature.split(/<br\s*\/?>/i).map((part, i, arr) => (
//                     <React.Fragment key={i}>
//                       {part.trim()}
//                       {i < arr.length - 1 && <br />}
...
//       <div className="flex flex-col xl:flex-row gap-2 mt-2 text-white w-[95%] lg:w-[85%] max-w-[1600px]">
